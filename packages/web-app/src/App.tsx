    ...
    <div className="App">
      ...
      <div className="container">
        <div className="container-title">
          ...
          <div>
            <input data-testid="serialNumberInput" value={serialNumber} onChange={(event) => setSerialNumber(event.target.value)} name="input-serial-number" type="text" />
            <button data-testid="addChargePointBtn" className="addButton" onClick={() => createChargePoint(serialNumber)}>
              Add
            </button>
          </div>
        </div>

        <ul className="list" data-testid="chargePointList">
